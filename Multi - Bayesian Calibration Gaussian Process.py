...
# # Resouce file
# folder = './3yc total light equip 6tc light equip fan infil chiller boiler 4xc'
# DataComp = np.asarray(pd.read_csv(folder + "/DATACOMP_Multi.csv"))
# DataField = np.asarray(pd.read_csv(folder + "/DATAFIELD_Multi.csv"))[:12,:]
# DataPred = np.asarray(pd.read_csv(folder + "/DATAFIELD_Multi.csv"))[12:,:]
...
folder = './5yc total equip heat 6tc light equip fan infil chiller boiler 4xc'
DataComp = np.asarray(pd.read_csv(folder + "/DATACOMP_Multi.csv"))
DataField = np.asarray(pd.read_csv(folder + "/DATAFIELD_Multi.csv"))[:12,:]
DataPred = np.asarray(pd.read_csv(folder + "/DATAFIELD_Multi.csv"))[12:,:]
output_folder = folder
...
# Resouce file
folder = './4yc total equip hvac 6tc light equip fan infil chiller boiler 4xc'
DataComp = np.asarray(pd.read_csv(folder + "/DATACOMP_Multi.csv"))
DataField = np.asarray(pd.read_csv(folder + "/DATAFIELD_Multi.csv"))[:12,:]
DataPred = np.asarray(pd.read_csv(folder + "/DATAFIELD_Multi.csv"))[12:,:]
output_folder = folder
...
# Resouce file
folder = './3yc total hvac heat 6tc light equip fan infil chiller boiler 4xc'
DataComp = np.asarray(pd.read_csv(folder + "/DATACOMP_Multi.csv"))
DataField = np.asarray(pd.read_csv(folder + "/DATAFIELD_Multi.csv"))[:12,:]
DataPred = np.asarray(pd.read_csv(folder + "/DATAFIELD_Multi.csv"))[12:,:]
output_folder = folder
...
#         DataComp_label.append(selected_days[j] + i*np.shape(RawDataField)[0])
